...
# Training directory
train_dir = os.listdir('friend-dataset/train/')

# Loop through each person in the training directory
for person in train_dir:
	pix = os.listdir("friend-dataset/train/" + person)

	# Loop through each training image for the current person
	for person_img in pix:
		print("[PROCESS] friend-dataset/train/" + person + "/" + person_img)
		# Get the face encodings for the face in each image file
		face = face_recognition.load_image_file("friend-dataset/train/" + person + "/" + person_img)
